...
function getSettingsEditorElements(): OptionsSettingsEditorElements {
  return {
    ...
    allowlist: requiredElement<HTMLTextAreaElement>('allowlist-rules'),
    allowlistValidation: requiredElement('allowlist-validation'),
    blocklist: requiredElement<HTMLTextAreaElement>('blocklist-rules'),
    blocklistValidation: requiredElement('blocklist-validation'),
    previewUrl: requiredElement<HTMLInputElement>('rule-preview-url'),
    previewResult: requiredElement('rule-preview-result'),
